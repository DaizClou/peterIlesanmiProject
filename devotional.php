...
<head>
    ...
    <!-- Core Css  -->
    <link rel="stylesheet" href="css/devotional.css?<?php echo time()?>">
</head>
...
<body>
    ...
    <section id='devotional' class="devotional-podcast-section">
        <div class='container-fluid'>
            <h2 class='text-center fw-bolder mt-3 mb-5'>Good Morning Jesus <br class="d-none d-md-block">Devotional
                Podcast (GMJ)
            </h2>
            <?php
      ...
      if($result->num_rows > 0){
        foreach($result as $row ){
          echo"
            <div class='row  devotional-item-wrapper'>
              <div class='col-md-6 mt-3 mb-4 devotional-item-left'>
                <p><span class='fw-bold'>Series</span>: ".$row['series']."</p>
                <p><span class='fw-bold'>Topic</span>: ".$row['topic']."</p>
                <p><span class='fw-bold'>Passage</span>: ".$row['passage']."</p>
                <audio class=' w-75' src='".$row['audio']."' controls loop></audio>
              </div>

              
              <div class='col-md-6 mb-4 devotional-item-right'>  
                <p class='pt-2'>".date('M dS, Y', strtotime($row['date']) ).". </p>
